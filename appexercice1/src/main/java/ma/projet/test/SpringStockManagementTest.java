...
import ma.projet.service.SpringProduitService;
...
public class SpringStockManagementTest {
    
    private ApplicationContext context;
    private CategorieService categorieService;
    private SpringProduitService produitService;
    private CommandeService commandeService;
    private LigneCommandeService ligneCommandeService;
    
    public SpringStockManagementTest() {
        // Initialisation du contexte Spring
        this.context = new AnnotationConfigApplicationContext(AppConfig.class);
        
        // Récupération des services
        this.categorieService = new CategorieService();
        this.produitService = context.getBean(SpringProduitService.class);
        this.commandeService = new CommandeService();
        this.ligneCommandeService = new LigneCommandeService();
    }
    
    public void runAllTests() {
        System.out.println("=== DÉBUT DES TESTS SPRING DE GESTION DE STOCK ===\n");
    ...
    public static void main(String[] args) {
        SpringStockManagementTest test = new SpringStockManagementTest();
        test.runAllTests();
    }
}
